...
public class p11_2 {
	...
	public static void main(String[] args) throws IOException {
		...
		///////////////////////////////////////////////////////////////////////
		//실습2) 20150112(아무 특정일자나)의 모든 종목을 추출하여 파일을 만드시오
		...
		File k39_f1 = new File ("C:\\Users\\kopo39\\Desktop\\SDP_2050112.csv");//SDP_2050112.csv파일로 콤마분리자 파일을 만든다.
		...
		while((readtxt = k39_br.readLine()) != null){ //한 줄씩 읽어서 readtxt변수에 저장
			...
			if (k39_field[1].contains("20150112")) {//필드[1]에 2150112가 포함되어 있다면
