...
public class p39_2_InputData {
	...
	public int[] k39_avg;//평균 배열에 저장
	
	p39_2_InputData(int iPerson){//생성자의 숫자(iPerson)의 크기 만큼 각 배열 생성 
		...
		k39_avg = new int[iPerson];// 총 iPerson개의 avg이 들어가는 double[]
	...
	void SetData(int i, String StudentName, int korean, int english, int mathematics) {
		...
		k39_avg[i] = k39_sum[i] / 3; //총점을 실수형으로 계산하기
	}
